...
export default class DepartamentoItem extends React.Component {
    ...
    render() {
      ...
      //      var departamentos = this.props.departamento;

        return <Dialog
            open={true}
        >
            <DialogTitle>{this.props.editar ? "Editar Departamento " + this.props.editar.id : "Novo Departamento"}</DialogTitle>
            <DialogContent>
                <TextField
                    autoFocus
                    margin="dense"
